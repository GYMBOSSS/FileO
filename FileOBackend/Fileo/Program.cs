...
class FileManager
{
    static void Main(string[] args)
    {
        ...
        while (true)
        {
            ...
            Console.WriteLine("14. Открыть PDF файл");
            Console.WriteLine("15. Найти файлы по дате добавления");
            Console.WriteLine("16. Найти файлы по маске");
            Console.WriteLine("17. Выйти");
            ...
            switch (choice)
            {
                ...
                case "13":
                    ...
                    break;
                case "14":
                    OpenPdfFile(currentDirectory);
                    break;
                case "15":
                    SearchFilesByDate(currentDirectory);
                    break;
                case "16":
                    SearchFilesByMask(currentDirectory);
                    break;
                case "17":
                    return;
    ...
    static void OpenPdfFile(string currentDirectory)
    {
        Console.Write("Введите имя PDF файла для открытия: ");
        var fileName = Console.ReadLine();
        string filePath = Path.Combine(currentDirectory, fileName);
        ...
        try
        {
            ...
            Console.WriteLine("PDF файл успешно открыт.");
        }
        catch (UnauthorizedAccessException ex)
        {
            Console.WriteLine("Ошибка доступа: " + ex.Message);
    ...
    static void SearchFilesByDate(string currentDirectory)
    {
    ...
    static void SearchFilesByMask(string currentDirectory)
    {
        Console.Write("Введите маску для поиска файлов (например, *test*.txt): ");
        ...
        try
        {
            ...
            var files = Directory.GetFiles(currentDirectory, mask, SearchOption.AllDirectories);
            if (files.Length == 0)
            {
                Console.WriteLine("Файлы не найдены.");
            }
